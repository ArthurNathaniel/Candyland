  ...
  <div class="overflow-hidden">
    ...
    <section>
      ...
      <div class="whole-vm">
        ...
        <div class="our-mission mm">
          <h3 class="mission-heading">Core Values</h3>
          <p>
            At Candyland School, our core values are the foundation of our
            culture and the principles that guide our decision-making. We
            believe in fostering an environment of respect, accountability,
            excellence, and teamwork.
            <li>
              <i class="fa-sharp fa-solid fa-circle-check change"></i> Respect:
              <br>
            </li>
            <li>
            <i class="fa-sharp fa-solid fa-circle-check change"></i> Accountability
          </li>
            <li>
            <i class="fa-sharp fa-solid fa-circle-check change"></i> Excellence
          </li>
          <li>
            <i class="fa-sharp fa-solid fa-circle-check change"></i> Team work
          </li>
          </p>
